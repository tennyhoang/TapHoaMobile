...
const MENU_ITEMS = [
  ...
  { icon: 'notifications-outline', label: 'Thông báo', color: '#F59E0B', route: null },
  { icon: 'shield-checkmark-outline', label: 'Bảo mật', color: '#22C55E', route: null },
  { icon: 'help-circle-outline', label: 'Hỗ trợ', color: '#3B82F6', route: null },
];
