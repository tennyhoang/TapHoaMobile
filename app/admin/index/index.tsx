...
const NAV_ITEMS = [
  ...
  },
  {
    icon: 'grid-outline',
    label: 'Danh mục',
    desc: 'Thêm, sửa, xoá danh mục sản phẩm',
    color: '#10B981',
  ...
  },
  {
    icon: 'people-outline',
    label: 'Người dùng',
    desc: 'Xem danh sách và phân quyền',
    color: '#8B5CF6',
    route: '/admin/users',
  },
  {
    icon: 'wallet-outline',
    label: 'Quản lý ví',
    desc: 'Duyệt yêu cầu nạp/rút tiền',
    color: '#06B6D4',
    route: '/admin/wallet',
  },
  {
    ...
    label: 'Kho hàng (Hub)',
    desc: 'Quản lý hệ thống kho trung chuyển',
    color: '#64748B',
    route: '/admin/hubs',
  },
  {
